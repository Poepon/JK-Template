    ...
    $(function () {
        ...
        _auditLogService.getEntityHistoryObjectTypes()
            .done(function (result) {
                ...
                $("#EntityTypeFullName").selectpicker("refresh");
            });
            ...
            columnDefs: [                
                {
                    ...
                    render: function (exception) {
                        ...
                        if (exception) {
                            $div.append($("<i/>").addClass("fa fa-close col-red").attr("title", app.localize("HasError")));
                        } else {
                            $div.append($("<i/>").addClass("fa fa-check bg-green").attr("title", app.localize("Success")));
                        }
                    ...
                    rowAction: {
                        element: $("<div/>")
                            ...
                            .append($("<button/>")
                                ...
                                .append($("<i/>").addClass("material-icons").text("search"))
                            ).click(function () {
        ...
        function showEntityChangeDetails(entityChange) {
            var entityChangeDetailModal = new app.ModalManager({
                viewUrl: abp.appPath + 'AuditLogs/EntityChangeDetailModal',
